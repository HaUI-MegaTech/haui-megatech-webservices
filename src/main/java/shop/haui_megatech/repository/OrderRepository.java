...
public interface OrderRepository extends JpaRepository<Order, Integer> {
        ...
        @Query(value = "SELECT o FROM Order o WHERE o.id = :orderId AND " +
                "o.user.id = :userId")
